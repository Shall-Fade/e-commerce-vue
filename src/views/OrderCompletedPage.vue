<template>
  <div>
    ...
    >
      <div class="max-w-[625px] w-full my-0 mx-auto text-center">
        <h2 class="text-[36px] font-bold text-navy-blue mb-[28px]">
          Your Order Is Completed!
        </h2>
        <p class="mb-[30px] font-lato font-semibold text-[16px] text-[#8D92A7]">
